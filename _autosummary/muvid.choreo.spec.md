...
The same two-layer split as [`muvid.lyricvid.spec`](muvid.lyricvid.spec.md#module-muvid.lyricvid.spec), for the same reason:
...
How events become objects. Each is a function in [`muvid.choreo.scene`](muvid.choreo.scene.md#module-muvid.choreo.scene).
