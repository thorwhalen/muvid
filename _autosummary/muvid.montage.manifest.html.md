...
[`muvid.montage`](muvid.montage.html.md#module-muvid.montage): this module is what a catalogue, a UI form, an MCP tool
...
The shape copies [`muvid.lyricvid.manifest`](muvid.lyricvid.manifest.html.md#module-muvid.lyricvid.manifest) on purpose — that file is the
...
[`muvid.montage.pipeline`](muvid.montage.pipeline.html.md#module-muvid.montage.pipeline), which reads `MUVID_MONTAGE_MAX_MEDIA`) so a
