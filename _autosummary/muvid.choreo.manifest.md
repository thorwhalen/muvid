...
[`muvid.choreo`](muvid.choreo.md#module-muvid.choreo): this module is what a catalogue, a UI form, an MCP tool
...
[`muvid.lyricvid.manifest`](muvid.lyricvid.manifest.md#module-muvid.lyricvid.manifest), which is the reference plugin.
...
it a different thing from [`muvid.visualize`](muvid.visualize.md#module-muvid.visualize).
