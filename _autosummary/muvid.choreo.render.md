...
Draw a [`ChoreoScene`](muvid.choreo.scene.md#muvid.choreo.scene.ChoreoScene) frame by frame and encode it.
...
mp4 [`muvid.visualize.video`](muvid.visualize.video.md#module-muvid.visualize.video) produces. Nothing touches the disk between
...
[`muvid.visualize.ffmpeg.run_ffmpeg()`](muvid.visualize.ffmpeg.md#muvid.visualize.ffmpeg.run_ffmpeg), because that helper has no stdin
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`Obj`](muvid.choreo.scene.md#muvid.choreo.scene.Obj)]
...
* **Raises:**
  * [**FfmpegError**](muvid.visualize.md#muvid.visualize.FfmpegError) – ffmpeg exited non-zero, died mid-stream, or overran
