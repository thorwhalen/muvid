...
* **Return type:**
  [`Plan`](muvid.montage.plan.md#muvid.montage.plan.Plan)
...
* **Return type:**
  [`TreatmentSpec`](muvid.montage.spec.md#muvid.montage.spec.TreatmentSpec)
...
Goes through [`muvid.subgenres.render_subgenre()`](muvid.subgenres.md#muvid.subgenres.render_subgenre) when the manifest is
...
| [`analysis`](muvid.montage.analysis.md#module-muvid.montage.analysis)   | Measure the song and the pool: beat grid, bars, sections, and media strength.                                             |
|-------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| [`manifest`](muvid.montage.manifest.md#module-muvid.montage.manifest)   | The montage subgenre's manifest — a beat-cut montage from a pool of stills and clips.                                     |
| [`pipeline`](muvid.montage.pipeline.md#module-muvid.montage.pipeline)   | The montage pipeline — the one path from a song and a pool to a finished video.                                           |
| [`plan`](muvid.montage.plan.md#module-muvid.montage.plan)           | The planner: a pool of media + a beat grid + sections -> an edit list of slots.                                           |
| [`render`](muvid.montage.render.md#module-muvid.montage.render)       | Render a [`Plan`](muvid.montage.plan.md#muvid.montage.plan.Plan) to a YouTube-spec mp4 with ffmpeg. |
| [`spec`](muvid.montage.spec.md#module-muvid.montage.spec)           | The montage treatment spec — what a director (human or model) decides, as data.                                           |
| [`tools`](muvid.montage.tools.md#module-muvid.montage.tools)         | The SSOT verbs for the montage subgenre: analyze, plan, render.                                                           |
