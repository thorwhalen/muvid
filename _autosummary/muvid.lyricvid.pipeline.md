...
Render one lyric video. Satisfies [`muvid.subgenres.Renderer`](muvid.subgenres.md#muvid.subgenres.Renderer).
...
`visual="auto"` in [`muvid.visualize`](muvid.visualize.md#module-muvid.visualize). It picks `ass` when this
