...
- [`muvid.footage.align`](muvid.footage.align.html.md#module-muvid.footage.align) — align a clip set to the song (thin over `mixing.audio`).
- [`muvid.footage.strategy`](muvid.footage.strategy.html.md#module-muvid.footage.strategy) — the pluggable `SelectionStrategy` registry that turns
...
- [`muvid.footage.edl`](muvid.footage.edl.html.md#module-muvid.footage.edl) — the `validate_edl` SSOT + EDL/alignment data types,
  including the per-cut `CropWindow` (the EDL’s spatial half, muvid#60).
- [`muvid.footage.look`](muvid.footage.look.html.md#module-muvid.footage.look) — the `looks` seam: compile a grade, a LUT or an
  in-shot punch-in (muvid#66) into the per-cut `-vf` fragment the assembler splices.
- [`muvid.footage.assemble`](muvid.footage.assemble.html.md#module-muvid.footage.assemble) — the bounded single-ffmpeg-pass assembler.
- [`muvid.footage.workspace`](muvid.footage.workspace.html.md#module-muvid.footage.workspace) — the per-user stateful project (song + clips + manifest).
...
muvid does not author this string: [`muvid.footage.look`](muvid.footage.look.html.md#module-muvid.footage.look) compiles it
...
[`muvid.footage.look.punch_in()`](muvid.footage.look.html.md#muvid.footage.look.punch_in) and
[`motion()`](muvid.footage.look.html.md#muvid.footage.look.motion) return a fragment that says `True`,
...
[`muvid.footage.strategy`](muvid.footage.strategy.html.md#module-muvid.footage.strategy)), so an unvouched entry surviving into its output means
...
| [`lacing_bridge`](muvid.footage.lacing_bridge.html.md#module-muvid.footage.lacing_bridge) | muvid project → lacing standoff records, and the DECISION tier back to an EDL.              |
| [`look`](muvid.footage.look.html.md#module-muvid.footage.look)                   | Compile a `looks` artifact into the fragment the assembler splices.                         |
| [`scoring`](muvid.footage.scoring.html.md#module-muvid.footage.scoring)             | Footage scoring — per-clip score tracks on the shared song-time grid (thorwhalen/muvid#13). |
| [`select_score`](muvid.footage.select_score.html.md#module-muvid.footage.select_score)   | The score-driven `weighted` selection strategy: a beat-snapped semi-Markov Viterbi DP.      |
| [`strategy`](muvid.footage.strategy.html.md#module-muvid.footage.strategy)           | The pluggable `SelectionStrategy` registry — alignments → an EDL.                           |
| [`workspace`](muvid.footage.workspace.html.md#module-muvid.footage.workspace)         | Per-user, STATEFUL project for the footage-aligned `music_video` genre.                     |
