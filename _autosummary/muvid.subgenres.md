...
* [`muvid.subgenres.testing`](muvid.subgenres.testing.md#module-muvid.subgenres.testing) — a conformance kit for plugin authors.
...
[`MusicVideoProject`](muvid.project.md#muvid.project.MusicVideoProject): a plugin coupled to muvid’s
...
| [`testing`](muvid.subgenres.testing.md#module-muvid.subgenres.testing)   | A conformance kit for subgenre plugin authors.   |
|-------------------------------------------------------------------------------------------|--------------------------------------------------|
