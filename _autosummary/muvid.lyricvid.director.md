...
1. the **schema** ([`muvid.lyricvid.spec`](muvid.lyricvid.spec.md#module-muvid.lyricvid.spec)), which constrains both runtimes;
...
3. the **prompt text**, which lives in `muvid/data/prompts/*.md` and is read
   ...
   [`muvid.lyricvid.spec.vocabulary()`](muvid.lyricvid.spec.md#muvid.lyricvid.spec.vocabulary) rather than restated in it.
...
[`muvid.lyricvid.spec.vocabulary()`](muvid.lyricvid.spec.md#muvid.lyricvid.spec.vocabulary) and the schema from
...
Every returned spec has been through [`coerce()`](muvid.lyricvid.spec.md#muvid.lyricvid.spec.coerce), so
