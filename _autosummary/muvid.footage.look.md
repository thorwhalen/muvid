...
[`muvid.footage.assemble`](muvid.footage.assemble.md#module-muvid.footage.assemble), where the bounded-memory invariant lives. The
fragment rides in [`muvid.footage.edl.EdlEntry.look`](muvid.footage.edl.md#muvid.footage.edl.EdlEntry.look) and is spliced by
...
outside [`muvid.footage.edl.LOOK_FILTERS`](muvid.footage.edl.md#muvid.footage.edl.LOOK_FILTERS). Compositing needs a second splice
...
from `PATH` ([`muvid.visualize.ffmpeg.run_ffmpeg()`](muvid.visualize.ffmpeg.md#muvid.visualize.ffmpeg.run_ffmpeg)), so that is what
...
[`Transition`](muvid.footage.edl.md#muvid.footage.edl.Transition) **restarts its ramp on the blended part**.
...
[`look_time_varying`](muvid.footage.edl.md#muvid.footage.edl.EdlEntry.look_time_varying), which is what the
...
[`muvid.footage.edl.LOOK_FILTERS`](muvid.footage.edl.md#muvid.footage.edl.LOOK_FILTERS) is\*\* — a new `looks` effect must be a
