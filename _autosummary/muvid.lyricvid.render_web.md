...
The web backend: a [`Scene`](muvid.lyricvid.scene.md#muvid.lyricvid.scene.Scene) as a deterministic
HTML page, screenshotted frame by frame and muxed with the song.

ASS ([`muvid.lyricvid.render_ass`](muvid.lyricvid.render_ass.md#module-muvid.lyricvid.render_ass)) is the default backend and should stay
...
[`compile_scene()`](muvid.lyricvid.scene.md#muvid.lyricvid.scene.compile_scene) and are written into the markup
...
* **Returns:**
  A [`RenderResult`](muvid.subgenres.md#muvid.subgenres.RenderResult) whose `artifacts['page']` is
