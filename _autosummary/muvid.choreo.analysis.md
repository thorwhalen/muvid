...
The visualizer ([`muvid.visualize`](muvid.visualize.md#module-muvid.visualize)) reads the spectrum continuously; this
...
of [`muvid.choreo.tools`](muvid.choreo.tools.md#module-muvid.choreo.tools), and the subprocess import-safety tests keep the
