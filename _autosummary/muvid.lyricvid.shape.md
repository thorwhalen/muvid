...
Coordinates out are exactly [`muvid.lyricvid.scene.Cue`](muvid.lyricvid.scene.md#muvid.lyricvid.scene.Cue)’s: `x`/`y` are
...
Three shape sources, one seam each ([`muvid.lyricvid.spec.ShapeRef`](muvid.lyricvid.spec.md#muvid.lyricvid.spec.ShapeRef)
...
| [`Placement`](#muvid.lyricvid.shape.Placement)(\*, text, x, y, size[, rotated])   | Where one word goes, in [`muvid.lyricvid.scene.Cue`](muvid.lyricvid.scene.md#muvid.lyricvid.scene.Cue)'s coordinates.   |
|-----------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
...
Keyword-only and frozen, like the [`Cue`](muvid.lyricvid.scene.md#muvid.lyricvid.scene.Cue) it
