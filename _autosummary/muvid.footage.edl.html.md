...
- **Compiled** — every filter the two compilers on this seam can emit:
  [`muvid.footage.look`](muvid.footage.look.html.md#module-muvid.footage.look) (`zoompan`/`crop`/`scale`/`setpts`, via
...
the beat-snapped Viterbi selector in [`muvid.footage.select_score`](muvid.footage.select_score.html.md#module-muvid.footage.select_score) exists to
