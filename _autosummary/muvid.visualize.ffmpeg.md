...
Low-level ffmpeg/ffprobe primitives shared across [`muvid.visualize`](muvid.visualize.md#module-muvid.visualize).
...
substrate under [`muvid.visualize.canvas`](muvid.visualize.canvas.md#module-muvid.visualize.canvas), [`muvid.visualize.visuals`](muvid.visualize.visuals.md#module-muvid.visualize.visuals),
[`muvid.visualize.reactive`](muvid.visualize.reactive.md#module-muvid.visualize.reactive), and [`muvid.visualize.video`](muvid.visualize.video.md#module-muvid.visualize.video).
