...
Pure given a [`FramePass`](muvid.footage.scoring.frames.md#muvid.footage.scoring.frames.FramePass) (one decode pass, shared with
[`motionbeat`](muvid.footage.scoring.motionbeat.md#module-muvid.footage.scoring.motionbeat)). Each per-frame signal is mapped from clip time to
